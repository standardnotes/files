...
import { AccountDeletionRequestedEvent, AccountDeletionRequestedEventPayload, DomainEventPublisherInterface, FileRemovedEvent } from '@standardnotes/domain-events'
...
describe('AccountDeletionRequestedEventHandler', () => {
  ...
  const createHandler = () => new AccountDeletionRequestedEventHandler(markFilesToBeRemoved, domainEventPublisher, domainEventFactory)
